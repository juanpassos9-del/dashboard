...
- **Volume como filtro duro dos sinais:** A validacao de volume do motor REV deve usar somente volume bruto da barra, media de volume, RVOL, volume da pernada e expansao de volume. Nao usar volume financeiro nessa etapa. Todo sinal deve exigir RVOL minimo configuravel e volume acima da media; reversao exige extremo + candle de rejeicao/falha + RVOL e expansao ou volume de pernada. O painel deve permitir ajustar lookback, RVOL minimo/forte, lookback da pernada e toggles de volume acima da media, expansao e bloqueio de volume caindo.
