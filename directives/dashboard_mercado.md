...
- **Calendario no Market Report:** A analise do Market Report deve incluir o calendario economico do dia, priorizando eventos `HIGH` e `MEDIUM` em horario de Brasilia. Na geracao do report, buscar primeiro o calendario ao vivo do Investing.com para obter Atual/Projecao/Anterior; usar `calendario_economico.json` apenas como fallback se o Investing falhar. Para cada evento relevante, destacar atual/projecao/anterior e uma interpretacao breve dos cenarios possiveis: acima da projecao, abaixo da projecao, hawkish/dovish ou impacto em juros, DXY, petroleo e indices.
