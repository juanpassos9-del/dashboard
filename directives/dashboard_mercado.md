...
- **Volume como filtro duro dos sinais:** A validacao de volume do motor REV deve usar somente volume bruto da barra, media de volume, RVOL, volume da pernada e expansao de volume. Nao usar volume financeiro nessa etapa. Todo sinal deve exigir RVOL minimo configuravel e volume acima da media; reversao exige extremo + RSI + candle de rejeicao/falha + RVOL e expansao ou volume de pernada. O painel deve permitir ajustar lookback, RVOL minimo/forte, lookback da pernada e toggles de volume acima da media, expansao e bloqueio de volume caindo.
...
- **Bandas percentuais VWAP:** O toggle `Bandas %` do grafico proprio deve desenhar as bandas percentuais de 0.5%, 1%, 1.5% e 2% apenas para VWAP diaria e VWAP semanal, com paletas bem diferentes por horizonte. Nao desenhar bandas percentuais da VWAP mensal.
