...
- **Bandas percentuais VWAP:** O toggle `Bandas %` do grafico proprio deve desenhar as bandas percentuais de 0.5%, 1%, 1.5% e 2% para VWAP diaria, VWAP semanal e VWAP mensal, com cores diferentes por horizonte.
