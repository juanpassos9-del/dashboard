...
- **Painel operacional Lightweight:** O componente proprio deve manter crosshair com leitura OHLC/volume/variação/distancia da VWAP, linhas de abertura/maxima/minima/fechamento anterior/preco atual, VWAP diaria/semanal/mensal, bandas percentuais e por desvio, medias SMA/EMA configuraveis, volume relativo, Volume Profile da sessao com POC destacado, oscilador de distancia da VWAP, markers BUY/SELL VWAP, alertas laterais, acoes de zoom/export/reload e preferencias em `localStorage`.
