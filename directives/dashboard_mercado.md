...
- **Calendario economico com Atual:** O endpoint Faireconomy/ForexFactory (`ff_calendar_thisweek.json`) normalmente nao entrega o campo `actual`; usar Investing.com como fonte primaria para `Atual/Projecao/Anterior` e manter Faireconomy apenas como fallback quando houver bloqueio/rate limit.
