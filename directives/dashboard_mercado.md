...
- **Calendario no Market Report:** A analise do Market Report deve incluir o calendario economico do dia, priorizando eventos `HIGH` e `MEDIUM` em horario de Brasilia. Para cada evento relevante, destacar atual/projecao/anterior e uma interpretacao breve dos cenarios possiveis: acima da projecao, abaixo da projecao, hawkish/dovish ou impacto em juros, DXY, petroleo e indices.
