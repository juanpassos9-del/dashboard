...
- **Volume financeiro nos sinais:** A validacao de volume do motor REV/TREND deve usar volume financeiro do candle (`close * volume`) contra a media financeira de 20 candles. O sinal so recebe confirmacao de volume quando o financeiro atual estiver acima dessa media e respeitar o multiplicador configurado no painel; RVOL bruto pode continuar aparecendo no painel apenas como leitura auxiliar.
