...
- **Desvios da VWAP:** O toggle `Desvios` do grafico proprio deve usar multiplicadores de desvio padrao `0.618`, `1`, `1.618` e `2`, mantendo as bandas percentuais da VWAP em toggle separado.
