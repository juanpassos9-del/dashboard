...
- **Relogio na sidebar:** A barra lateral deve exibir um relogio compacto logo abaixo da navegacao principal, com horario de Brasilia renderizado diretamente no Streamlit, fonte grande e marcadores de abertura `09:00 Abertura BR`, `10:00 Abertura acoes BR` e `10:30 Abertura NY`, destacando proximo evento, evento em andamento e eventos ja passados.
